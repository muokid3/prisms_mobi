...
public class SiteMainFragment extends Fragment {
    ...
    private static SiteMainFragment instance = null;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_site_main_study, container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new SitesFragment(), "SITES");
        adapter.addFragment(new StudiesFragment(), "STUDIES");
    ...
    public void reloadFrag(){
        ...
        NavHostFragment.findNavController(SiteMainFragment.this).navigate(
                R.id.nav_site_main,
                null,
                new NavOptions.Builder()
                        .setPopUpTo(R.id.nav_site_main, true)
                        .build()
        );
